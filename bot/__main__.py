...
enabled_ext = [
    "bot.cogs.sudocog",
    "bot.cogs.help",
    "bot.cogs.utilitiescog",
    "bot.cogs.listenercog",
    "bot.cogs.converter",
]
...
# copy EasyEDAFootprintScraper to the tempdir
os.system(f"cp -r {os.path.join(rootdir, 'EasyEDAFootprintScraper')} {tempdir}")

# define the bot class
class converterBot(bridge.Bot):
    def __init__(self, command_prefix, dirname, rootdir, tempdir, datadir, help_command=None, description=None, **options):
...
print(f"Starting converter v {__version__} ...")
bot = converterBot(prefix, dirname, rootdir, tempdir, datadir, intents=intents)
